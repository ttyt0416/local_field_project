...
VIDEO_PROMPT_ENHANCEMENT_SYSTEM_PROMPT = (
    ...
    "negative is one short overall sentence with at most eight comma-separated clauses for unwanted transitions, objects, subtitles, watermarks, and style drift. "
    "Never repeat vocabulary or make exhaustive body-part, anatomy, or category lists. "
