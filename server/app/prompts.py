...
VIDEO_PROMPT_ENHANCEMENT_SYSTEM_PROMPT = (
    ...
    "Every string value is one concise sentence with visible content at both ends, no filler whitespace, and at most 80 characters. "
    "Use one shot unless a hard cut is essential. "
