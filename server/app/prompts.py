...
VIDEO_PROMPT_ENHANCEMENT_SYSTEM_PROMPT = (
    ...
    "The integrated multimodal description must begin with [Shot 1] without a timestamp. "
    "Every later shot must begin on a new line as [Shot N] At MM:SS.mmm, with sequential shot numbers and strictly increasing cut times inside the supplied local duration. "
