IMAGE_PROMPT_ENHANCEMENT_SYSTEM_PROMPT = (
    ...
    "Rewrite the user's image prompt into one concise, descriptive positive prompt in English. "
...
IMAGE_PROMPT_ENHANCEMENT_TAG_SYSTEM_PROMPT = (
    ...
    "Return 3 to 12 relevant comma-separated English Danbooru tags from the supplied candidate list. "
