...
`/generate/image?family=anima|illustrious`는 query family에 맞는 checkpoint·LoRA options와 backend loader를 사용한다. Anima는 Diffusion Model, Illustrious는 full checkpoint다. 제목은 `T2I (Anima)` 또는 `T2I (Illustrious)`로 표시한다.
